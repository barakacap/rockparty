            ...
            <div className='facts-inner'>
                <div className='facts-text'>
                    ...
                    <div className='facts-section-text'>
                        ...
                        <p className='ffam-mont fs-s tc-white'>
                            No Price Tiers. No Bonding Curves. Every Rock Party Backstage Pass is the same price for everyone .15 ETH. 25 passes are being withheld from the launch. These will be utilized for promotional purposes as well as creators and launch supporters.
                        </p>
                    </div>
